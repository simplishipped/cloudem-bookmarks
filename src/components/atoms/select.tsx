...
const Select: Component<SelectProps> = (props) => {
  ...
  let ChoiceElement = (choice: any) => {
    return (
      <div
        class="hover:bg-primaryLight select-none dark:hover:bg-primaryDark cursor-pointer rounded-md dark:border-textDark text-textLight dark:text-textDark border-textLight border-2  mt-2 w-full flex items-center justify-between" style={{ padding: '8px 8px 10px 8px' }}>
